			...
			top: {
				...
				...(out.tab === 'sprays'
					? {
							...
							flexIds: loadout.expressionIds.top.flexIds,
						}
					: {
							...
							sprayIds: loadout.expressionIds.top.sprayIds,
						}),
			},
		},
	};
...
export async function loader({ params }: LoaderFunctionArgs) {
	...
	const selectedSprays = loadout.expressionIds.top.sprayIds;
	...
	const selectedFlex = loadout.expressionIds.top.flexIds;
