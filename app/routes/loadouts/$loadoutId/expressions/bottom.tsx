			...
			bottom: {
				...
				...(out.tab === 'sprays'
					? {
							...
							flexIds: loadout.expressionIds.bottom.flexIds,
						}
					: {
							...
							sprayIds: loadout.expressionIds.bottom.sprayIds,
						}),
			},
		},
	};
...
export async function loader({ params }: LoaderFunctionArgs) {
	...
	const selectedSprays = loadout.expressionIds.bottom.sprayIds;
	...
	const selectedFlex = loadout.expressionIds.bottom.flexIds;
