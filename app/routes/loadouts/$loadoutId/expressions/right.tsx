			...
			right: {
				...
				...(out.tab === 'sprays'
					? {
							...
							flexIds: loadout.expressionIds.right.flexIds,
						}
					: {
							...
							sprayIds: loadout.expressionIds.right.sprayIds,
						}),
			},
		},
	};
...
export async function loader({ params }: LoaderFunctionArgs) {
	...
	const selectedSprays = loadout.expressionIds.right.sprayIds;
	...
	const selectedFlex = loadout.expressionIds.right.flexIds;
